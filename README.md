...
| Backend & Logic | Node.js, Python, C++ |
...
- 🏠 [ObroyLand](https://obroyland.xyz) — Full Stack Real Estate Platform (Next.js, Supabase, Genkit AI)
- ❄️ [AC Servicing Doha](https://acservicingdoha.vercel.app) — Professional AC & Plumbing Services, Qatar
